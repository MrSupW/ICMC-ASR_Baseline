...
def main():
    ...
    if local_rank == 0:
        print(model)
        print('the number of encoder params: {:,d}'.format((sum(p.numel() for p in model.encoder.parameters()))))
        print('the number of decoder params: {:,d}'.format((sum(p.numel() for p in model.decoder.parameters()))))
        print('the number of ctc params: {:,d}'.format((sum(p.numel() for p in model.ctc.parameters()))))
        print('the number of predictor params: {:,d}'.format((sum(p.numel() for p in model.predictor.parameters()))))
        print('the number of joint params: {:,d}'.format((sum(p.numel() for p in model.joint.parameters()))))
        print('the number of model params: {:,d}'.format(sum(p.numel() for p in model.parameters())))
