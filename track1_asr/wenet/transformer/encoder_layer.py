...
class MOEEncoderLayer(nn.Module):
    ...
    def __init__(self, size: int,
        ...
        self.fc_use = adapter  # 1null 2cn 3en 4cn_en
    ...
    def forward(self,
        ...
        if self.fc_use == 1:
            ...
            x = residual_adapter + self.fc_cn(x)
        elif self.fc_use == 3:
            x = residual_adapter + self.fc_en(x)
        elif self.fc_use == 4:
            x = residual_adapter + self.fc_cn(x) + self.fc_en(x)
